...
const Footer = () => {
    return (
        <div>
            <footer className="flex bg-blue-100 p-4 rounded-sm mt-6 mb-4 w-full flex-row flex-wrap items-center justify-center gap-y-6 gap-x-12 border-t border-blue-gray-50 py-6 text-center md:justify-between">
